...
- [x] Move `python -m src.train` out of `entrypoint.sh` and into the GitLab CI `train` stage (LEARNING_PATH step 9). The inference container should not know how to train.
