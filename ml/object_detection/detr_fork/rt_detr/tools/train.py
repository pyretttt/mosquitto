...
def main():
    ...
    if args.val:
        ...
        train_dataloader = DataLoader(
            ...
            drop_last=True,
            collate_fn=BatchImageCollateFuncion(
                scales=[480, 512, 544, 576, 608, 640, 640, 640, 672, 704, 736, 768, 800], stop_epoch=71
            ),
        )
        fit(
            model=model,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--weight_path", "-w", type=str, default=None, help="path to the weight file (default: None)")

    parser.add_argument(
        "--save_dir",
        "-s",
        type=str,
        default="output/rtdetr_r18vd_6x_coco",
    ...
    parser.add_argument("--val", type=str2bool, default=False, help="if True, only evaluate the model (default: False)")
    ...
    parser.add_argument("--ema", type=str2bool, default=True, help="Use Exponential Moving Average (default: True)")
