...
100 mb per sec is 1e+8 bytes per sec. RTT is round trip time 20 milliseconds. MSS maximum segment size is 1460 bytes.
...
BDP = 100 * 1e6 / 8 * 0.02 = 250000 bits
...
if RTT = 0.2 sec then BDP = 2.500.000 bits
